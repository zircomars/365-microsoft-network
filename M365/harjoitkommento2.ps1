...
-------                                    ----------- ------                               --------
<addusername>@<something>.onmicrosoft.com AzureCloud  <asdfdsafuewir123>                     <TenantId_is something>
...
Account                             Environment Tenant                               TenantId
-------                             ----------- ------                               --------
zhaot@OpiframeOy837.onmicrosoft.com AzureCloud  <login_userTenantId_is-something>             <login_userTenantId_is-something>
...
-------                              -----------        ----------  --------  ------------       -----------
<login_userTenantId_is-something> talvi-Office -M... Public      False     msteams_ec3436     talvi-Office -M...


Add-TeamUser -GroupId <GroupID> -User AlexW@_YourTenant_.onmicrosoft.com

Add-TeamUser -GroupId <TenantId_is something, mitä kirjauduttiin> -User <addusername>@<something>.onmicrosoft.com

-----------------------------------------------------------------------------------------------------------------------------

Muita asetuksia

New-TeamChannel -GroupId <login_userTenantId_is-something> -DisplayName "SupportNimi"

PS C:\WINDOWS\system32> New-TeamChannel -GroupId <login_userTenantId_is-something> -DisplayName "SupportNimi"
...
New-TeamChannel -GroupId <login_userTenantId_is-something> -DisplayName "Recruiting"
PS C:\WINDOWS\system32> New-TeamChannel -GroupId 5<login_userTenantId_is-something> -DisplayName "Recruitingasdf"

Id                                               DisplayName    Description MembershipType
--                                               -----------    ----------- --------------
19:390a036adb9c4e83806faa9f8a1cfa1b@thread.tacv2 Recruitingasdf                   Standard

New-TeamChannel -GroupId <login_userTenantId_is-something> -DisplayName "Administration" -MembershipType Private


PS C:\WINDOWS\system32> New-TeamChannel -GroupId <login_userTenantId_is-something> -DisplayName "Administration" -MembershipType Private
