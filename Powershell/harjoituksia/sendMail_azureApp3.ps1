...
#Send Mail, torecipient (To the recipient) for single person, but bcc recipients also same idea as to recipients, but who will receive email can not cc email list if got multiple email accounts.
